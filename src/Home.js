...
const handleFilterButtonClick_TAB2 = async () => {
  // try {
        ...
        // Let's say we want to remove multiple keys, e.g., 'unwantedKey1', 'unwantedKey2'
        ...
        if (selectedKPI.includes('1st Trimester Registration (%)')){
          temp_trendsDataTab2_1 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage 1st Trimester to Total ANC Registration"]).toFixed(1)),
        ...
        if (selectedKPI.includes('Institutional Delivery (%)')){
           temp_trendsDataTab2_2 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage Institutional deliveries to Total Reported Deliveries"]).toFixed(1)),
                month: responseTab2Data_block.map(item => item["month"]) ,
              }
            ]
          };
        ...
        if (selectedKPI.includes('Low Birth Weight (%)')){
          temp_trendsDataTab2_3 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage Low birth weight babies (less than 2500g)"]).toFixed(1)),
                month: responseTab2Data_block.map(item => item["month"]) ,
              }
            ]
          };
        ...
        if (selectedKPI.includes('NQAS certified health facilities (%)')){
          temp_trendsDataTab2_4 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage of NQAS certified facilities"]).toFixed(1)),
                month: responseTab2Data_block.map(item => item["month"]) ,
              }
            ]
          };
        ...
        if (selectedKPI.includes('Person screened for Hypertension (%)')){
          temp_trendsDataTab2_5 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage of person screened for Hypertension against targeted population"]).toFixed(1)),
                month: responseTab2Data_block.map(item => item["month"]) ,
              }
            ]
          };
        ...
        if (selectedKPI.includes('Person screened for Diabetes (%)')){
          temp_trendsDataTab2_6 = {
            series: [
              ...
              {
                name: ["Block Average"],
                data: responseTab2Data_block.map(item => parseFloat(item["Percentage of person screened for Diabetes against targeted population"]).toFixed(1)),
                month: responseTab2Data_block.map(item => item["month"]) ,
              }
            ]
          };
        ...
        if (selectedKPI.includes('Treatment success rate (%)')){
            temp_trendsDataTab2_7 = {
              series: [
                ...
                {
                  name: ["Block Average"],
                  data: responseTab2Data_block.map(item => parseFloat(item["Percentage of number of TB cases treated successfully in public and private institutions"]).toFixed(1)),
                  month: responseTab2Data_block.map(item => item["month"]) ,
                }
              ]
            };
...
const handleFilterButtonClick_TAB3 = async () => {
  ...
  temp_trendsDataTab3_1 = [
    ...
    },
    {
      ...
      percentage: responseTab3Data_block.map(item => parseFloat(item["Percentage 1st Trimester to Total ANC Registration"]))[0].toFixed(1)
  ...
  temp_trendsDataTab3_2 = [
    ...
    {
      label: responseTab3Data_block[0].block,
      percentage: responseTab3Data_block.map(item => parseFloat(item["Percentage Institutional deliveries to Total Reported Deliveries"]))[0].toFixed(1)
      ...
      datasets: [
        {
          data: [responseTab3Data_nat.map(item => parseFloat(item["natAvg Low Birth Weight"]))[0].toFixed(1),
                  responseTab3Data_state.map(item => parseFloat(item["stAvg Low Birth Weight"]))[0].toFixed(1),
                    ...
                    responseTab3Data_block.map(item => parseFloat(item["Percentage Low birth weight babies (less than 2500g)"]).toFixed(1))[0]],
          backgroundColor: ['#00e676', '#DDDDDD'],
          hoverBackgroundColor: ['#00e676', '#DDDDDD']
        },
      ],
    ...
    datasets: [
      {
        data: [responseTab3Data_nat.map(item => parseFloat(item["natAvg NQAS"]))[0].toFixed(1),
                responseTab3Data_state.map(item => parseFloat(item["stAvg NQAS"]))[0].toFixed(1),
                  ...
                  responseTab3Data_block.map(item => parseFloat(item["Percentage of NQAS certified facilities"]).toFixed(1))[0]],
        backgroundColor: ['#00e676', '#DDDDDD'],
        hoverBackgroundColor: ['#00e676', '#DDDDDD']
      },
    ],
    ...
    datasets: [
      {
        data: [responseTab3Data_nat.map(item => parseFloat(item["natAvg Hypertension"]))[0].toFixed(1),
                responseTab3Data_state.map(item => parseFloat(item["stAvg Hypertension"]))[0].toFixed(1),
                  ...
                  responseTab3Data_block.map(item => parseFloat(item["Percentage of person screened for Hypertension against targeted population"]).toFixed(1))[0]],
        backgroundColor: ['#00e676', '#DDDDDD'],
        hoverBackgroundColor: ['#00e676', '#DDDDDD']
      },
    ],
    ...
    datasets: [
      {
        data: [responseTab3Data_nat.map(item => parseFloat(item["natAvg Diabetes "]))[0].toFixed(1),
                responseTab3Data_state.map(item => parseFloat(item["stAvg Diabetes "]))[0].toFixed(1),
                  ...
                  responseTab3Data_block.map(item => parseFloat(item["Percentage of person screened for Diabetes against targeted population"]).toFixed(1))[0]],
        backgroundColor: ['#00e676', '#DDDDDD'],
        hoverBackgroundColor: ['#00e676', '#DDDDDD']
      },
    ],
  ...
  temp_trendsDataTab3_7 = {
    ...
    [responseTab3Data_block[0].block + ' - ' + responseTab3Data_block.map(item => parseFloat(item["Percentage of number of TB cases treated successfully in public and private institutions"]))[0].toFixed(1) + '%']: {
      labels: ['Block Avg'],
      datasets: [
        {
          data: [responseTab3Data_block.map(item => parseFloat(item["Percentage of number of TB cases treated successfully in public and private institutions"]))[0], 100 - responseTab3Data_block.map(item => parseFloat(item["Percentage of number of TB cases treated successfully in public and private institutions"]))[0]],
